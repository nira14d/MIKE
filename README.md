<div align="center">
  <br />
    <a href="https://youtu.be/tS7upsfuxmo?feature=shared" target="_blank">
      <img src="https://github.com/adrianhajdin/mike_landing_page/assets/151519281/36013f49-ba13-47ad-a6c4-f9d58bfae7fc" alt="Project Banner">
    </a>
  <br />
...
Master Tailwind CSS in two parts by first learning fundamentals, advanced techniques, and theming. Then, build a stunning mike landing page, applying learned skills to create a visually impressive website.
...
while building a beautiful mike Website with a,

👉 **Complex Hero Section**: A visually appealing hero section showcasing key elements.

👉 **Popular Products Showcase**: A section highlighting popular mike products
...
```bash
git clone https://github.com/adrianhajdin/mike_landing_page.git
cd mike_landing_page
```
...
export const products = [
    {
        imgURL: shoe4,
        name: "mike Air Jordan-01",
        price: "$200.20",
    },
    {
        imgURL: shoe5,
        name: "mike Air Jordan-10",
        price: "$210.20",
    },
    {
        imgURL: shoe6,
        name: "mike Air Jordan-100",
        price: "$220.20",
    },
    {
        imgURL: shoe7,
        name: "mike Air Jordan-001",
        price: "$230.20",
    },
];
